...
export const config = {
   ...
   getVideoId(){
    ...
    playerConf: [//type 1综合 2金币 3血量
        ...
        {id:2,type:3,coin:1,hp:2,unlocklv:5,unlocktype:1,unlockcost:200,name:"大枪徒"},
        {id:3,type:2,coin:2,hp:1,unlocklv:10,unlocktype:2,unlockcost:2,name:"枪者"},
        {id:4,type:2,coin:2,hp:1,unlocklv:20,unlocktype:1,unlockcost:4000,name:"大枪者"},
        {id:5,type:1,coin:2,hp:2,unlocklv:30,unlocktype:2,unlockcost:4,name:"枪士"},
        {id:6,type:3,coin:1,hp:3,unlocklv:40,unlocktype:2,unlockcost:4,name:"大枪士"},
        {id:7,type:2,coin:3,hp:1,unlocklv:50,unlocktype:1,unlockcost:20000,name:"枪师"},
        {id:8,type:1,coin:3,hp:2,unlocklv:60,unlocktype:2,unlockcost:6,name:"大枪师"},
        {id:9,type:1,coin:2,hp:2,unlocklv:70,unlocktype:1,unlockcost:55000,name:"枪灵"},
        {id:10,type:3,coin:1,hp:4,unlocklv:80,unlocktype:1,unlockcost:160000,name:"大枪灵"},
        {id:11,type:2,coin:4,hp:1,unlocklv:90,unlocktype:2,unlockcost:4,name:"枪宗"},
        {id:12,type:2,coin:5,hp:2,unlocklv:100,unlocktype:1,unlockcost:225000,name:"大枪宗"},
        {id:13,type:2,coin:6,hp:2,unlocklv:110,unlocktype:2,unlockcost:12,name:"枪王"},
        {id:14,type:1,coin:4,hp:5,unlocklv:120,unlocktype:2,unlockcost:20,name:"大枪王"},
        {id:15,type:1,coin:3,hp:2,unlocklv:130,unlocktype:1,unlockcost:300000,name:"枪皇"},
        {id:16,type:2,coin:5,hp:2,unlocklv:140,unlocktype:2,unlockcost:10,name:"枪尊"},
        {id:17,type:1,coin:3,hp:4,unlocklv:150,unlocktype:2,unlockcost:12,name:"枪圣"},
        {id:18,type:1,coin:4,hp:4,unlocklv:160,unlocktype:2,unlockcost:16,name:"枪帝"},
        {id:19,type:1,coin:5,hp:4,unlocklv:180,unlocktype:1,unlockcost:1000000,name:"枪神"},
    ],
    ...
    gunConf:[
        ...
        {id:3,type:2,fire:1,num:3,speed:0.08,unlocklv:5,unlocktype:2,unlockcost:1,anchor:cc.v2(0.4,0.5), aim:cc.v2(38,0),name:"乌兹"},
        {id:4,type:2,fire:2,num:3,speed:0.12,unlocklv:10,unlocktype:1,unlockcost:3000,anchor:cc.v2(0.35,0.5), aim:cc.v2(77,-3),name:"M-4"},
        {id:5,type:2,fire:2,num:3,speed:0.12,unlocklv:20,unlocktype:2,unlockcost:2,anchor:cc.v2(0.38,0.5), aim:cc.v2(65,-4),name:"AK-47"},
        {id:6,type:1,fire:3,num:1,speed:0.2,unlocklv:30,unlocktype:1,unlockcost:8000,anchor:cc.v2(0.35,0.4), aim:cc.v2(66,-6),name:"侦察者"},
        {id:7,type:3,fire:2,num:3,speed:0.2,unlocklv:40,unlocktype:2,unlockcost:2,anchor:cc.v2(0.32,0.5), aim:cc.v2(56,-1),name:"温切斯特1887"},
        {id:8,type:2,fire:3,num:3,speed:0.18,unlocklv:50,unlocktype:2,unlockcost:3,anchor:cc.v2(0.4,0.4), aim:cc.v2(71,-5),name:"M240"},
        {id:9,type:1,fire:4,num:1,speed:0.2,unlocklv:60,unlocktype:1,unlockcost:45000,anchor:cc.v2(0.35,0.4), aim:cc.v2(75,-5),name:"AWP"},
        {id:10,type:1,fire:5,num:1,speed:0.2,unlocklv:70,unlocktype:2,unlockcost:3,anchor:cc.v2(0.35,0.4), aim:cc.v2(88,-8),name:"巴雷特M82A1"},
        {id:11,type:3,fire:2,num:4,speed:0,unlocklv:80,unlocktype:2,unlockcost:3,anchor:cc.v2(0.4,0.5), aim:cc.v2(67,-8),name:"超级散弹枪"},
        {id:12,type:2,fire:2,num:4,speed:0.06,unlocklv:90,unlocktype:1,unlockcost:100000,anchor:cc.v2(0.4,0.4), aim:cc.v2(55,-8),name:"P90"},
        {id:13,type:3,fire:3,num:2,speed:0,unlocklv:100,unlocktype:1,unlockcost:160000,anchor:cc.v2(0.35,0.4), aim:cc.v2(74,-4),name:"麻烦制造者"},
        {id:14,type:2,fire:2,num:4,speed:0.15,unlocklv:110,unlocktype:2,unlockcost:3,anchor:cc.v2(0.4,0.4), aim:cc.v2(83,0),name:"毁灭者"},
        {id:15,type:3,fire:2,num:5,speed:0,unlocklv:120,unlocktype:2,unlockcost:3,anchor:cc.v2(0.4,0.54), aim:cc.v2(66,-5),name:"死神"},
        {id:16,type:2,fire:1,num:5,speed:0.06,unlocklv:130,unlocktype:1,unlockcost:225000,anchor:cc.v2(0.45,0.54), aim:cc.v2(46,-5),name:"幻灭"},
        {id:17,type:1,fire:5,num:1,speed:0,unlocklv:140,unlocktype:2,unlockcost:3,anchor:cc.v2(0.4,0.5), aim:cc.v2(40,-5),name:"神力"},
        {id:18,type:2,fire:3,num:3,speed:0.08,unlocklv:150,unlocktype:1,unlockcost:300000,anchor:cc.v2(0.38,0.5), aim:cc.v2(77,-7),name:"STAG"},
        {id:19,type:1,fire:7,num:1,speed:0,unlocklv:160,unlocktype:2,unlockcost:3,anchor:cc.v2(0.45,0.45), aim:cc.v2(64,-15),name:"巨人"},
        {id:20,type:2,fire:3,num:4,speed:0.08,unlocklv:180,unlocktype:1,unlockcost:1000000,anchor:cc.v2(0.4,0.5), aim:cc.v2(38,-2),name:"火星枪"}
    ], 
